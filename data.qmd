...
ggplot(data3, aes(x=substr(title, 8, nchar(title)), y=fct_rev(time), fill=missing))+
  ...
  theme_bw()+
  theme(axis.text.y = element_text(size = rel(0.5)),
        axis.text.x = element_text(angle = 90, vjust = 0.5, size = rel(0.6)))
```
